...
public class WebConfig implements ServletContextInitializer {
	...
	/**
	 * The following @Bean method enables the use of @Scope("view") in @Component
	 * Spring beans (JSF backing bean definitions)
	 */
	@Bean
...
//	}
	...
	/**
	 * Register org.primefaces.webapp.filter.FileUploadFilter to use with Primefaces
	 * fileupload commons option
	 * 
	...
	/*
	 * https://stackoverflow.com/questions/22544214/spring-boot-and-jsf-primefaces-
	 * richfaces
	 * 
	 * update, turn out this might not needed:
	 * https://stackoverflow.com/questions/20264083/configuration-of-com-sun-faces-
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		 ...
		 * facesServlet.setLoadOnStartup(1); facesServlet.addMapping("*.xhtml");
		 */
...
//				"/WEB-INF/functions.taglib.xml;/WEB-INF/springsecurity.taglib.xml;/WEB-INF/bootforum.taglib.xml");
		...
		// without the following line, at startup, got: java.lang.IllegalStateException:
